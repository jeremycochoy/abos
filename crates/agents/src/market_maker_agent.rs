...
mod tests {
    ...
    fn bid_fill_increases_inventory() {
        ...
        agent.on_exchange_message(
            ...
            ExchangeMessage::OrderFilled {
                order_id: 1, user_id: 0, symbol: 0, side: Side::Bid, price: 100, qty: 10, remaining: 0, notional: 1_000,
            },
        );
    ...
    fn ask_fill_decreases_inventory() {
        ...
        agent.on_exchange_message(
            0, 0,
            ExchangeMessage::OrderFilled {
                order_id: 1, user_id: 0, symbol: 0, side: Side::Ask, price: 100, qty: 10, remaining: 0, notional: 1_000,
            },
        );
    ...
    fn mixed_fills_track_net_inventory() {
        ...
        agent.on_exchange_message(
            0, 0,
            ExchangeMessage::OrderFilled {
                order_id: 2, user_id: 0, symbol: 0, side: Side::Ask, price: 101, qty: 7, remaining: 0, notional: 707,
            },
        );
    ...
    fn fill_without_prior_accept_still_counts() {
        ...
        agent.on_exchange_message(
            0, 0,
            ExchangeMessage::OrderFilled {
                order_id: 999, user_id: 0, symbol: 0, side: Side::Bid, price: 100, qty: 10, remaining: 0, notional: 1_000,
            },
        );
